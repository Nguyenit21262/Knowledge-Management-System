          ...
          <div className="overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-[0_6px_20px_rgba(15,23,42,0.05)]">
            {recentDocuments.map((document) => (
              <Link
                key={document.id}
                to={`/documents/${document.id}`}
                className="flex flex-col items-start justify-between gap-4 border-b border-slate-100 px-5 py-5 last:border-b-0 sm:px-6 sm:py-6 lg:flex-row lg:items-center lg:gap-6"
              >
