    ...
    <section className="rounded-[28px] border border-slate-200 bg-white px-12 py-12 shadow-[0_6px_20px_rgba(15,23,42,0.06)]">
      <div className="mb-10 flex items-start justify-between gap-8">
        <div className="flex items-center gap-4">
          <div className="flex h-[72px] w-[72px] items-center justify-center rounded-3xl bg-[#dbe3ff] text-[#4f46ff]">
            <ResourceIcon className="h-8 w-8" strokeWidth={1.8} />
          </div>
          <span className="rounded-full bg-slate-100 px-5 py-2 text-[1.05rem] font-normal text-slate-700">
            {document.subject}
          </span>
        </div>
      ...
      <div className="mb-10">
        <h1 className="mb-6 text-[3rem] leading-tight font-semibold tracking-tight text-slate-950">
          {document.title}
        </h1>
