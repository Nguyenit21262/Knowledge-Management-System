      ...
      <div className="mb-12">
        <div className="mb-5 flex items-start gap-4">
          ...
          <textarea
            ...
            className="min-h-[145px] flex-1 resize-none rounded-3xl border border-slate-300 px-6 py-5 text-[1.1rem] text-slate-700 outline-none placeholder:text-slate-400"
          />
        </div>
